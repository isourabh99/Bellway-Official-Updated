...
const SplitSection = ({ imageSrc, heading, content, imageOnLeft = true }) => {
  return (
    <div className="w-full flex flex-col md:flex-row items-start justify-center  my-20 px-2 md:px-20 gap-10">
      {/* PART 1 */}
      {imageOnLeft && (
        <motion.div
      ...
      >
        <h2 className="text-3xl md:text-4xl font-seminbold mb-4 text-zinc-800 ">
          {heading}
        </h2>
